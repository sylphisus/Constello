...
Origin Conversation states the phenomenology — what recognition feels like. Architectural Deepening states the technical constraint it imposes — what the matching system must do to honor it. The sherpa line in the first doc is the experience; the sherpa line in the second is the same line forced to do load-bearing work in an infrastructure argument.